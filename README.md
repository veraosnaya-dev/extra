...
<title> INTELIGENCIA ARTIFICIAL </title><!--titulo que aparece en la pestaña-->
<style>
...
nav{
   background: #651991;/*fondo gris oscuro */
}
nav ul {
...
<body>
  ...
  <input type="submit" value="Buscar"></p>
    ...
    <li>
          <p><a href="ma1.html">INFORMACION</a></p>  <!--Flecha indicando subtema-->
        <ul>
        <li><a href="infor1.HTML">-INFORMACION-</a></li>
        
      </ul>
       </li>
      <li>
          <p><a href="ma2.html">INFORMACION 2</a></p> <!--Flecha indicando subtema-->
        <ul>
        <li><a href="infor2.html">INFORMACION-2</a></li>
        
      </ul>
       </li>
       <li>
          <p><a href="ma3.html">INFORMACION 3</a></p> <!--Flecha indicando subtema-->
        <ul>
        <li><a href="infor3.html">INFORMACION-3</a></li>
        
      </ul>
       </li>
       <li>
          <p><a href="ma4.html">INFORMACION 4</a></p>  <!--Flecha indicando subtema-->
        <ul>
        <li><a href="infor4.html">INFORMACION-4</a></li>
        
      </ul>
       </li>
 <li>
       <p><a href="ma5.html">INFORMACION 5</a></p>  <!--Flecha indicando subtema-->
        <ul>
        <li><a href="infor5.html">INFORMACION-5</a></li>
